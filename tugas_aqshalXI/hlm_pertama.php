...
<body>
    <div class="container">
        <table class="tabel_1" border="0">
            <tr>
                <th colspan="4"><h4>Destinasi Wisata Di Yogyakarta</h4></th>
            </tr>
            <tr>
                <th>1.</th>
                <th>Bukit Bintang</th>
        ...
        <form action="hlm_kedua.php" method="post">
            <table class="tabel_2" border="0">
                ...
                <tr>
                    <th colspan="2">Note : Tiket takan berpengaruh ketika pergi ke Pendopo Lawas seperti Cintaku Tidak Akan Berpengaruh Jika kamu masih dengannya ea</th>
                </tr>
                <tr>

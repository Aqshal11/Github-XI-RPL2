...
if ($_SESSION['pilih_1'] == 7) {
    ...
    <form action="hlm_ketiga.php" method="post">
        <table class="tabel_a1" border="0">
            ...
            <tr>
                <th><label for="menu__5">5. Lemon Tea</label></th>
                <th>Rp. 10.000</th>
...
$_SESSION['ulang'] = true;
    ...
    <table class="tabel_b3">
        ...
        <tr>
            <th>
                <a href="hlm_pertama.php">
                    <link rel="stylesheet" href="hlm_pertama.php">Kembali Ke Halaman Awal
                </a>
            </th>
        </tr>
    </table>
